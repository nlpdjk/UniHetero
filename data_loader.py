...
def process_bert(data, tokenizer, vocab):
    ...
    for index, instance in enumerate(data):
        ...
        _entity_text = set([decode.convert_index_to_text(e["index"], vocab.label_to_id(e["type"]))
...
def load_data_bert(config):
    ...
    tokenizer = AutoTokenizer.from_pretrained(config.bert_path, cache_dir="./cache/")
